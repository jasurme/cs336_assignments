...
def run_embedding(
    ...
    embed.load_state_dict({"embedding_matrix": weights})
...
def run_swiglu(
    ...
    from cs336_basics.transformer import PositionwiseFeedForward
...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.transformer import CasualMultiHeadSelfAttention
    attention = CasualMultiHeadSelfAttention(d_model, num_heads)
    return attention.multihead_self_attention(q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight, in_features )
...
def run_multihead_self_attention_with_rope(
    ...
    from cs336_basics.transformer import CasualMultiHeadSelfAttention
    attention = CasualMultiHeadSelfAttention(d_model, num_heads)
    return attention.multihead_self_attention(q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight, in_features,True, theta, max_seq_len, token_positions )
...
def run_rope(
    ...
    Returns:
        Float[Tensor, " ... sequence_length d_k"]: Tensor with RoPE input.
    """
...
max_seq_len
    ...
    return transformer_lm(vocab_size, context_length, num_layers, d_model, num_heads, d_ff, rope_theta, weights, in_indices)
...
def run_get_batch(
    ...
    """
    from cs336_basics.transformer import data_loading
...
def get_tokenizer(
    ...
    """
    from cs336_basics.encode_decode import Tokenizer
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    voc, mergs = train_bpe(input_path, vocab_size, special_tokens)
    return (voc, mergs)
