...
def get_flashattention_autograd_function_pytorch() -> type:
    ...
    from cs336_systems.flashattention import FA2FunctionPytorchAutograd
    return FA2FunctionPytorchAutograd
...
def get_flashattention_autograd_function_triton() -> type:
    ...
    from tutorial.tritn import FA2_Forward_Triton
    return FA2_Forward_Triton
...
def get_ddp(module: torch.nn.Module) -> torch.nn.Module:
    ...
    from cs336_systems.d import Overlapping_DDP
    return Overlapping_DDP(module)
    # raise NotImplementedError
...
def ddp_on_after_backward(ddp_model: torch.nn.Module, optimizer: torch.optim.Optimizer):
    ...
    # from cs336_systems.d import Overlapping_DDP
    # overlapping_ddp = Overlapping_DDP(ddp_model)
...
def get_fsdp(module: torch.nn.Module, compute_dtype: torch.dtype | None = None) -> torch.nn.Module:
    ...
    """
    from cs336_systems.d import FullySharded_DataParallelTraining
    return FullySharded_DataParallelTraining(module, compute_dtype)
...
def get_sharded_optimizer(params, optimizer_cls: type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    ...
    """
    from cs336_systems.d import Optimizer_State_Sharder

    return Optimizer_State_Sharder(params, optimizer_cls,**kwargs )
